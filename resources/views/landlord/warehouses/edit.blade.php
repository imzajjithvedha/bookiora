        ...
        <form action="{{ route('landlord.warehouses.update', $warehouse) }}" method="POST" enctype="multipart/form-data" class="form">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    ...
                    <x-input-error field="address_en"></x-backend.input-error>
                </div>
                ...
                <div class="col-6 mb-4">
                    ...
                    <x-input-error field="storage_type_id"></x-backend.input-error>
                </div>
                ...
                <div class="col-6 mb-4">
                    ...
                    <x-input-error field="total_area"></x-backend.input-error>
                </div>
                ...
                <div class="col-6 mb-4">
                    ...
                    <x-input-error field="total_pallets"></x-backend.input-error>
                </div>
                ...
                <div class="col-6 mb-4">
                    ...
                    <x-input-error field="available_pallets"></x-backend.input-error>
                </div>
                ...
                <div class="col-6 mb-4">
                    ...
                    <x-input-error field="rent_per_pallet"></x-backend.input-error>
                </div>
                ...
                <div class="col-6 mb-4">
                    ...
                    <x-input-error field="pallet_dimension"></x-backend.input-error>
                </div>
                ...
                <div class="col-6 mb-4 pallet-dimension-other-value {{ $warehouse->pallet_dimension_other_value == null ? 'd-none' : '' }}">
                    ...
                    <x-input-error field="pallet_dimension_other_value"></x-backend.input-error>
                </div>
                ...
                <div class="col-6 mb-4">
                    ...
                    <x-input-error field="temperature_type"></x-backend.input-error>
                </div>
                ...
                <div class="col-6 mb-4">
                    ...
                    <x-input-error field="temperature_range"></x-backend.input-error>
                </div>
                ...
                <div class="col-3 mb-4">
                    ...
                    <x-input-error field="wms"></x-backend.input-error>
                </div>
                ...
                <div class="col-3 mb-4">
                    ...
                    <x-input-error field="equipment_handling"></x-backend.input-error>
                </div>
                ...
                <div class="col-3 mb-4">
                    ...
                    <x-input-error field="temperature_sensor"></x-backend.input-error>
                </div>
                ...
                <div class="col-3 mb-4">
                    ...
                    <x-input-error field="humidity_sensor"></x-backend.input-error>
                </div>
                ...
                <div class="col-12 mb-4">
                    <x-upload-image old_name="old_thumbnail" old_value="{{ $warehouse->thumbnail ?? old('thumbnail')  }}" new_name="new_thumbnail" path="warehouses" label="Thumbnail"></x-backend.upload-image>
                    <x-input-error field="new_thumbnail"></x-backend.input-error>
                </div>

                <div class="col-12 mb-4">
                    <x-upload-image old_name="old_outside_image" old_value="{{ $warehouse->outside_image ?? old('outside_image') }}" new_name="new_outside_image" path="warehouses" label="Outside"></x-backend.upload-image>
                    <x-input-error field="new_outside_image"></x-backend.input-error>
                </div>

                <div class="col-12 mb-4">
                    <x-upload-image old_name="old_loading_image" old_value="{{ $warehouse->loading_image ?? old('loading_image') }}" new_name="new_loading_image" path="warehouses" label="Loading"></x-backend.upload-image>
                    <x-input-error field="new_loading_image"></x-backend.input-error>
                </div>

                <div class="col-12 mb-4">
                    <x-upload-image old_name="old_off_loading_image" old_value="{{ $warehouse->off_loading_image ?? old('off_loading_image') }}" new_name="new_off_loading_image" path="warehouses" label="Off Loading"></x-backend.upload-image>
                    <x-input-error field="new_off_loading_image"></x-backend.input-error>
                </div>

                <div class="col-12 mb-4">
                    <x-upload-image old_name="old_handling_equipment_image" old_value="{{ $warehouse->handling_equipment_image ?? old('handling_equipment_image') }}" new_name="new_handling_equipment_image" path="warehouses" label="Handling Equipment"></x-backend.upload-image>
                    <x-input-error field="new_handling_equipment_image"></x-backend.input-error>
                </div>

                <div class="col-12 mb-4">
                    <x-upload-image old_name="old_storage_area_image" old_value="{{ $warehouse->storage_area_image ?? old('storage_area_image') }}" new_name="new_storage_area_image" path="warehouses" label="Storage Area"></x-backend.upload-image>
                    <x-input-error field="new_storage_area_image"></x-backend.input-error>
                </div>

                <div class="col-12 mb-4">
                    <x-upload-multi-videos video_count="8" old_name="old_videos" old_value="{{ $warehouse->videos ?? old('videos') }}" new_name="new_videos[]" path="warehouses"></x-backend.upload-multi-videos>
                    <x-input-error field="new_videos.*"></x-backend.input-error>
                </div>

                <div class="col-12 mb-4">
                    <x-upload-multi-images image_count="4" old_name="old_licenses" old_value="{{ $warehouse->licenses ?? old('licenses') }}" new_name="new_licenses[]" path="warehouses" label="License"></x-backend.upload-multi-images>
                    <x-input-error field="new_licenses.*"></x-backend.input-error>
                </div>

                <x-edit :data="$warehouse"></x-backend.edit>
