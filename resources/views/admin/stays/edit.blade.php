        ...
        <form action="{{ route('admin.stays.update', $stay) }}" method="POST" enctype="multipart/form-data" class="form">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none breakfast-cost">
                    ...
                    <input type="number" class="form-control input-field" id="breakfast_cost" name="breakfast_cost" placeholder="Breakfast Cost" value="{{ old('breakfast_cost', $stay->breakfast_cost) }}" required>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none parking-cost">
                    ...
                    <input type="number" class="form-control input-field" id="parking_cost" name="parking_cost" placeholder="Parking Cost" value="{{ old('parking_cost', $stay->parking_cost) }}" required>
