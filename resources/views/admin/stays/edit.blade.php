...
@section('title', 'Edit Stay')

@section('content')
    <div class="inner-page">
        <form action="{{ route('admin.stays.update', $stay) }}" method="POST" enctype="multipart/form-data" class="form">
            @csrf
            <div class="page-details mb-3 mb-md-4">
                <p class="title raleway">Stay Details</p>
                <p class="description">View or update stay details. Save changes to apply.</p>
            </div>

            <div class="row">
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    <label for="name" class="form-label label">Name<span class="asterisk">*</span></label>
                    <input type="text" class="form-control input-field" id="name" name="name" placeholder="Name" value="{{ old('name', $stay->name) }}" required>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select js-single input-field" id="user_id" name="user_id" required>
                        ...
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" {{ old('user_id', $stay->user_id) == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-12 mb-3 mb-md-4">
                    ...
                    <input type="hidden" id="address" name="address" value="{{ $stay->address }}" required>
                    <input type="hidden" id="latitude" name="latitude" value="{{ $stay->latitude }}" required>
                    <input type="hidden" id="longitude" name="longitude" value="{{ $stay->longitude }}" required>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <input type="text" class="form-control input-field" id="apartment_floor_number" name="apartment_floor_number" placeholder="Apartment or floor number" value="{{ old('apartment_floor_number', $stay->apartment_floor_number) }}">
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <input type="text" class="form-control input-field" id="city" name="city" placeholder="City" value="{{ old('city', $stay->city) }}" required>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <input type="text" class="form-control input-field" id="post_code" name="post_code" placeholder="Post code" value="{{ old('post_code', $stay->post_code) }}" required>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select js-single input-field" id="country" name="country">
                        <x-countries-list :data="old('country', $stay->country)"></x-countries-list>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="star_rating" name="star_rating" required>
                        ...
                        <option value="na" {{ old('star_rating', $stay->star_rating) == 'na' ? "selected" : "" }}>Not Available</option>
                        <option value="1" {{ old('star_rating', $stay->star_rating) == '1' ? "selected" : "" }}>1</option>
                        <option value="2" {{ old('star_rating', $stay->star_rating) == '2' ? "selected" : "" }}>2</option>
                        <option value="3" {{ old('star_rating', $stay->star_rating) == '3' ? "selected" : "" }}>3</option>
                        <option value="4" {{ old('star_rating', $stay->star_rating) == '4' ? "selected" : "" }}>4</option>
                        <option value="5" {{ old('star_rating', $stay->star_rating) == '5' ? "selected" : "" }}>5</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="breakfast" name="breakfast" required>
                        ...
                        <option value="yes" {{ old('breakfast', $stay->breakfast) == 'yes' ? "selected" : "" }}>Yes</option>
                        <option value="no" {{ old('breakfast', $stay->breakfast) == 'no' ? "selected" : "" }}>No</option>
                    </select>
                ...
                <div class="col-12 mb-3 mb-md-4 d-none breakfast-types">
                    ...
                    <div class="checks">
                        <x-breakfast-types-list :data="old('breakfast_types', json_decode($stay->breakfast_types))"></x-breakfast-types-list>
                    </div>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none breakfast-pay">
                    ...
                    <select class="form-select input-field" id="breakfast_pay" name="breakfast_pay" required>
                        <option value="">Select</option>
                        <option value="yes" {{ old('breakfast_pay', $stay->breakfast_pay) == 'yes' ? "selected" : "" }}>Yes</option>
                        <option value="no" {{ old('breakfast_pay', $stay->breakfast_pay) == 'no' ? "selected" : "" }}>No</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none breakfast-cost">
                    ...
                    <input type="number" class="form-control input-field" id="breakfast_cost" name="breakfast_cost" placeholder="Breakfast cost" value="{{ old('breakfast_cost', $stay->breakfast_cost) }}" min="0" step="0.01" required>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="parking" name="parking" required>
                        <option value="">Select</option>
                        <option value="yes_free" {{ old('parking', $stay->parking) == 'yes_free' ? "selected" : "" }}>Yes, free</option>
                        <option value="yes_paid" {{ old('parking', $stay->parking) == 'yes_paid' ? "selected" : "" }}>Yes, paid</option>
                        <option value="no" {{ old('parking', $stay->parking) == 'no' ? "selected" : "" }}>No</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none parking-reserve">
                    ...
                    <select class="form-select input-field" id="parking_reserve" name="parking_reserve" required>
                        <option value="">Select</option>
                        <option value="yes" {{ old('parking_reserve', $stay->parking_reserve) == 'yes' ? "selected" : "" }}>Reservation needed</option>
                        <option value="no" {{ old('parking_reserve', $stay->parking_reserve) == 'no' ? "selected" : "" }}>No reservation needed</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none parking-location">
                    ...
                    <select class="form-select input-field" id="parking_location" name="parking_location" required>
                        <option value="">Select</option>
                        <option value="onsite" {{ old('parking_location', $stay->parking_location) == 'onsite' ? "selected" : "" }}>On site</option>
                        <option value="offsite" {{ old('parking_location', $stay->parking_location) == 'offsite' ? "selected" : "" }}>Off site</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none parking-type">
                    ...
                    <select class="form-select input-field" id="parking_type" name="parking_type" required>
                        <option value="">Select</option>
                        <option value="private" {{ old('parking_type', $stay->parking_type) == 'private' ? "selected" : "" }}>Private</option>
                        <option value="public" {{ old('parking_type', $stay->parking_type) == 'public' ? "selected" : "" }}>Public</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none parking-cost">
                    ...
                    <input type="number" class="form-control input-field" id="parking_cost" name="parking_cost" placeholder="Parking Cost" value="{{ old('parking_cost', $stay->parking_cost) }}" min="0" step="0.01" required>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none parking-cost-type">
                    ...
                    <select class="form-select input-field" id="parking_cost_type" name="parking_cost_type" required>
                        <option value="">Select</option>
                        <option value="per_hour" {{ old('parking_cost_type', $stay->parking_cost_type) == 'per_hour' ? "selected" : "" }}>Per hour</option>
                        <option value="per_day" {{ old('parking_cost_type', $stay->parking_cost_type) == 'per_day' ? "selected" : "" }}>Per day</option>
                        <option value="per_stay" {{ old('parking_cost_type', $stay->parking_cost_type) == 'per_stay' ? "selected" : "" }}>Per stay</option>
                    </select>
                ...
                <div class="col-12 mb-3 mb-md-4">
                    ...
                    <div class="checks">
                        <x-facilities-list :data="old('facilities', json_decode($stay->facilities))"></x-facilities-list>
                    </div>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select js-single input-field" id="check_in_time_from" name="check_in_time_from">
                        <x-times-list :data="old('check_in_time_from', $stay->check_in_time_from)"></x-times-list>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select js-single input-field" id="check_in_time_until" name="check_in_time_until">
                        <x-times-list :data="old('check_in_time_until', $stay->check_in_time_until)"></x-times-list>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select js-single input-field" id="check_out_time_from" name="check_out_time_from">
                        <x-times-list :data="old('check_out_time_from', $stay->check_out_time_from)"></x-times-list>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select js-single input-field" id="check_out_time_until" name="check_out_time_until">
                        <x-times-list :data="old('check_out_time_until', $stay->check_out_time_until)"></x-times-list>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="allow_children" name="allow_children" required>
                        <option value="">Select</option>
                        <option value="yes" {{ old('allow_children', $stay->allow_children) == 'yes' ? "selected" : "" }}>Yes</option>
                        <option value="no" {{ old('allow_children', $stay->allow_children) == 'no' ? "selected" : "" }}>No</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="allow_pets" name="allow_pets" required>
                        <option value="">Select</option>
                        <option value="yes" {{ old('allow_pets', $stay->allow_pets) == 'yes' ? "selected" : "" }}>Yes</option>
                        <option value="no" {{ old('allow_pets', $stay->allow_pets) == 'no' ? "selected" : "" }}>No</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4 d-none allow-pets-charges">
                    ...
                    <select class="form-select input-field" id="allow_pets_charges" name="allow_pets_charges" required>
                        <option value="">Select</option>
                        <option value="yes" {{ old('allow_pets_charges', $stay->allow_pets_charges) == 'yes' ? "selected" : "" }}>Charges may apply</option>
                        <option value="no" {{ old('allow_pets_charges', $stay->allow_pets_charges) == 'no' ? "selected" : "" }}>Pets can stay for free</option>
                    </select>
                    <x-input-error field="allow_pets_charges"></x-input-error>
                </div>

                <div class="col-12 mb-3 mb-md-4">
                    <x-upload-image-must old_name="old_thumbnail" old_value="{{ old('thumbnail', $stay->thumbnail) }}" new_name="new_thumbnail" path="stays" label="thumbnail"></x-upload-image-must>
                    <x-input-error field="new_thumbnail"></x-input-error>
                </div>

                <div class="col-12 mb-3 mb-md-4">
                    <x-upload-multi-images image_count="10" old_name="old_images" old_value="{{ old('images', $stay->images) }}" new_name="new_images[]" path="stays" label="images"></x-upload-multi-images>
                    <x-input-error field="new_images.*"></x-input-error>
                </div>

                <x-edit-status :data="$stay"></x-edit>
            </div>
        </form>
    </div>
@endsection
