...
@section('content')
    <div class="inner-page">
        <form action="{{ route('admin.stays.rooms.update', [$stay, $stay_room]) }}" method="POST" enctype="multipart/form-data" class="form">
            @csrf
            <div class="page-details mb-3 mb-md-4">
                <p class="title raleway">{{ $stay->name }}: Room Details</p>
                <p class="description">View or update room details. Save changes to apply.</p>
            </div>

            <div class="row">
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    <label for="custom_name" class="form-label label">Custom name</label>
                    <input type="text" class="form-control input-field" id="custom_name" name="custom_name" placeholder="Custom name" value="{{ old('custom_name', $stay_room->custom_name) }}">
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select js-single input-field" id="name" name="name" required>
                        <x-stay-room-names-list :data="old('name', $stay_room->name)"></x-stay-room-names-list>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select js-single input-field" id="type" name="type" required>
                        <x-stay-room-types-list :data="old('type', $stay_room->type)"></x-stay-room-types-list>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="number_of_rooms" name="number_of_rooms" placeholder="Number of rooms" value="{{ old('number_of_rooms', $stay_room->number_of_rooms) }}" min="1" required>
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="single_bed_count" name="single_bed_count" placeholder="Single bed count" value="{{ old('single_bed_count', $stay_room->single_bed_count) }}" min="0" required>
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="double_bed_count" name="double_bed_count" placeholder="Double bed count" value="{{ old('double_bed_count', $stay_room->double_bed_count) }}" min="0" required>
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="large_bed_count" name="large_bed_count" placeholder="Large bed count" value="{{ old('large_bed_count', $stay_room->large_bed_count) }}" min="0" required>
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="extra_large_double_bed_count" name="extra_large_double_bed_count" placeholder="XL double bed count" value="{{ old('extra_large_double_bed_count', $stay_room->extra_large_double_bed_count) }}" min="0" required>
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="bunk_bed_count" name="bunk_bed_count" placeholder="Bunk bed count" value="{{ old('bunk_bed_count', $stay_room->bunk_bed_count) }}" min="0" required>
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="sofa_bed_count" name="sofa_bed_count" placeholder="Sofa bed count" value="{{ old('sofa_bed_count', $stay_room->sofa_bed_count) }}" min="0" required>
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="futon_mat_count" name="futon_mat_count" placeholder="Futon mat count" value="{{ old('futon_mat_count', $stay_room->futon_mat_count) }}" min="0" required>
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="number_of_guests" name="number_of_guests" placeholder="Futon Mat" value="{{ old('number_of_guests', $stay_room->number_of_guests) }}" min="1" required>
                ...
                <div class="col-12 col-md-4 col-lg-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="smoking_allowed" name="smoking_allowed" required>
                        ...
                        <option value="yes" {{ old('smoking_allowed', $stay_room->smoking_allowed) == 'yes' ? "selected" : "" }}>Yes</option>
                        <option value="no" {{ old('smoking_allowed', $stay_room->smoking_allowed) == 'no' ? "selected" : "" }}>No</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="bathroom_private" name="bathroom_private" required>
                        <option value="">Select</option>
                        <option value="yes" {{ old('bathroom_private', $stay_room->bathroom_private) == 'yes' ? "selected" : "" }}>Yes</option>
                        <option value="no" {{ old('bathroom_private', $stay_room->bathroom_private) == 'no' ? "selected" : "" }}>No, it's shared</option>
                    </select>
                ...
                <div class="col-12 mb-3 mb-md-4">
                    ...
                    <div class="checks">
                        <x-stay-room-bathroom-items-list :data="old('bathroom_items', json_decode($stay_room->bathroom_items))"></x-stay-room-bathroom-items-list>
                    </div>
                ...
                <div class="col-12 mb-3 mb-md-4">
                    ...
                    <div class="checks">
                        <x-stay-room-general-amenities-list :data="old('general_amenities', json_decode($stay_room->general_amenities))"></x-stay-room-general-amenities-list>
                    </div>
                ...
                <div class="col-12 mb-3 mb-md-4">
                    ...
                    <div class="checks">
                        <x-stay-room-outdoor-views-list :data="old('outdoor_views', json_decode($stay_room->outdoor_views))"></x-stay-room-outdoor-views-list>
                    </div>
                ...
                <div class="col-12 mb-3 mb-md-4">
                    ...
                    <div class="checks">
                        <x-stay-room-food-drinks-list :data="old('food_drinks', json_decode($stay_room->food_drinks))"></x-stay-room-food-drinks-list>
                    </div>
                ...
                <div class="col-12 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="charge_per_night" name="charge_per_night" placeholder="Charge per night" value="{{ old('charge_per_night', $stay_room->charge_per_night) }}" min="0" step="0.01" required>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="free_cancellation_window" name="free_cancellation_window" required>
                        <option value="">Select</option>
                        <option value="Before 18:00 on the day of arrival" {{ old('free_cancellation_window', $stay_room->free_cancellation_window) == 'Before 18:00 on the day of arrival' ? "selected" : "" }}>Before 18:00 on the day of arrival</option>
                        <option value="Up to 1 day before the day of arrival" {{ old('free_cancellation_window', $stay_room->free_cancellation_window) == 'Up to 1 day before the day of arrival' ? "selected" : "" }}>Up to 1 day before the day of arrival</option>
                        <option value="Up to 2 days before the day of arrival" {{ old('free_cancellation_window', $stay_room->free_cancellation_window) == 'Up to 2 days before the day of arrival' ? "selected" : "" }}>Up to 2 days before the day of arrival</option>
                        <option value="Up to 3 days before the day of arrival" {{ old('free_cancellation_window', $stay_room->free_cancellation_window) == 'Up to 3 days before the day of arrival' ? "selected" : "" }}>Up to 3 days before the day of arrival</option>
                        <option value="Up to 4 days before the day of arrival" {{ old('free_cancellation_window', $stay_room->free_cancellation_window) == 'Up to 4 days before the day of arrival' ? "selected" : "" }}>Up to 4 days before the day of arrival</option>
                        <option value="Up to 7 days before the day of arrival" {{ old('free_cancellation_window', $stay_room->free_cancellation_window) == 'Up to 7 days before the day of arrival' ? "selected" : "" }}>Up to 7 days before the day of arrival</option>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="windows_cancellation_payment" name="windows_cancellation_payment" required>
                        <option value="">Select</option>
                        <option value="Cost of the first night" {{ old('windows_cancellation_payment', $stay_room->windows_cancellation_payment) == 'Cost of the first night' ? "selected" : "" }}>Cost of the first night</option>
                        <option value="100% of the total price" {{ old('windows_cancellation_payment', $stay_room->windows_cancellation_payment) == '100% of the total price' ? "selected" : "" }}>100% of the total price</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="non_refundable_rate_plan" name="non_refundable_rate_plan" required>
                        <option value="">Select</option>
                        <option value="yes" {{ old('non_refundable_rate_plan', $stay_room->non_refundable_rate_plan) == 'yes' ? "selected" : "" }}>Yes</option>
                        <option value="no" {{ old('non_refundable_rate_plan', $stay_room->non_refundable_rate_plan) == 'no' ? "selected" : "" }}>No</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="non_refundable_rate_discount" name="non_refundable_rate_discount" placeholder="Futon Mat" value="{{ old('non_refundable_rate_discount', $stay_room->non_refundable_rate_discount) }}" min="0" required>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <select class="form-select input-field" id="weekly_rate_plan" name="weekly_rate_plan" required>
                        <option value="">Select</option>
                        <option value="yes" {{ old('weekly_rate_plan', $stay_room->weekly_rate_plan) == 'yes' ? "selected" : "" }}>Yes</option>
                        <option value="no" {{ old('weekly_rate_plan', $stay_room->weekly_rate_plan) == 'no' ? "selected" : "" }}>No</option>
                    </select>
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-4">
                    ...
                    <input type="number" class="form-control input-field" id="weekly_rate_discount" name="weekly_rate_discount" placeholder="Discount" value="{{ old('weekly_rate_discount', $stay_room->weekly_rate_discount) }}" min="0" required>
                    <x-input-error field="weekly_rate_discount"></x-input-error>
                </div>

                <div class="col-12 mb-3 mb-md-4">
                    <x-upload-image-must old_name="old_thumbnail" old_value="{{ old('thumbnail', $stay_room->thumbnail) }}" new_name="new_thumbnail" path="stays" label="thumbnail"></x-upload-image-must>
                    <x-input-error field="new_thumbnail"></x-input-error>
                </div>

                <div class="col-12 mb-3 mb-md-4">
                    <x-upload-multi-images image_count="5" old_name="old_images" old_value="{{ old('images', $stay_room->images) }}" new_name="new_images[]" path="stays" label="images"></x-upload-multi-images>
                    <x-input-error field="new_images.*"></x-input-error>
                </div>

                <x-edit-status :data="$stay_room"></x-edit>
            </div>
        </form>
    </div>
@endsection
