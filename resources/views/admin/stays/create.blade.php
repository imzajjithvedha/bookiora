    ...
    <div class="inner-page">
        <form action="{{ route('admin.stays.store') }}" method="POST" enctype="multipart/form-data" class="form">
            ...
            <div class="row">
                ...
                <div class="col-6 mb-4 breakfast-pay">
                ...
                <div class="col-6 mb-4 breakfast-cost">
                ...
                <div class="col-12 mb-4">
                    ...
                    <div class="checks">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="À la carte" id="breakfast-type-01">
                            <label class="form-check-label" for="breakfast-type-01">
                                À la carte
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="American" id="breakfast-type-02">
                            <label class="form-check-label" for="breakfast-type-02">
                                American
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Asian" id="breakfast-type-03">
                            <label class="form-check-label" for="breakfast-type-03">
                                Asian
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Breakfast To Go" id="breakfast-type-04">
                            <label class="form-check-label" for="breakfast-type-04">
                                Breakfast To Go
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Buffet" id="breakfast-type-05">
                            <label class="form-check-label" for="breakfast-type-05">
                                Buffet
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Continental" id="breakfast-type-06">
                            <label class="form-check-label" for="breakfast-type-06">
                                Continental
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Full English/ Irish" id="breakfast-type-07">
                            <label class="form-check-label" for="breakfast-type-07">
                                Full English/ Irish
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Gulten-Free" id="breakfast-type-08">
                            <label class="form-check-label" for="breakfast-type-08">
                                Gulten-Free
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Halal" id="breakfast-type-09">
                            <label class="form-check-label" for="breakfast-type-09">
                                Halal
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Italian" id="breakfast-type-10">
                            <label class="form-check-label" for="breakfast-type-10">
                                Italian
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Kosher" id="breakfast-type-11">
                            <label class="form-check-label" for="breakfast-type-11">
                                Kosher
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Vegan" id="breakfast-type-12">
                            <label class="form-check-label" for="breakfast-type-12">
                                Vegan
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="breakfast_types[]" value="Vegetarian" id="breakfast-type-13">
                            <label class="form-check-label" for="breakfast-type-13">
                                Vegetarian
                            </label>
                        </div>
                    </div>
                ...
                <div class="col-6 mb-4 parking-reserve">
                ...
                <div class="col-6 mb-4 parking-location">
                ...
                <div class="col-6 mb-4 parking-type">
                ...
                <div class="col-6 mb-4 parking-cost">
                ...
                <div class="col-12 mb-4">
                    ...
                    <div class="checks">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Restaurant" id="facility-01">
                            <label class="form-check-label" for="facility-01">
                                Restaurant
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Room Service" id="facility-02">
                            <label class="form-check-label" for="facility-02">
                                Room Service
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Bar" id="facility-03">
                            <label class="form-check-label" for="facility-03">
                                Bar
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="24-hour Front Desk" id="facility-04">
                            <label class="form-check-label" for="facility-04">
                                24-hour Front Desk
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Sauna" id="facility-05">
                            <label class="form-check-label" for="facility-05">
                                Sauna
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Fitness Centre" id="facility-06">
                            <label class="form-check-label" for="facility-06">
                                Fitness Centre
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Garden" id="facility-07">
                            <label class="form-check-label" for="facility-07">
                                Garden
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Terrace" id="facility-08">
                            <label class="form-check-label" for="facility-08">
                                Terrace
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Non-smoking Rooms" id="facility-09">
                            <label class="form-check-label" for="facility-09">
                                Non-smoking Rooms
                            </label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Airport Shuttle" id="facility-10">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Family Rooms" id="facility-11">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Spa and Wellness Centre" id="facility-12">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Hot Tub/ Jacuzzi" id="facility-13">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Free WiFi" id="facility-14">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Air Conditioning" id="facility-15">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Water park" id="facility-16">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Electric Vehicle Charging Station" id="facility-17">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Swimming Pool" id="facility-18">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="facilities[]" value="Beach" id="facility-19">
                ...
                <div class="col-12 mb-4">
                    <x-upload-image old_name="old_thumbnail" old_value="{{ old('thumbnail') }}" new_name="new_thumbnail" path="stays" label="Thumbnail"></x-upload-image>
                    <x-input-error field="new_thumbnail"></x-input-error>
                </div>

                <div class="col-12 mb-4">
                    <x-upload-multi-images image_count="10" old_name="old_images" old_value="{{ old('images') }}" new_name="new_images[]" path="stays"></x-upload-multi-images>
...
@push('after-scripts')
    ...
    <script src="{{ asset('js/google-map.js') }}" data-maps-key="{{ config('services.google_maps.key') }}"></script>
